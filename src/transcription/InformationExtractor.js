  ...
  function extract(text, utterances, openaiApiKey) {
    ...
    try {
      ...
      var systemPrompt = "あなたは顧客との営業電話の会話から重要な情報を正確に抽出するアシスタントです。" +
                         ...
                         "- summary: 会話の要約（300文字以内）\n" +
                         "\n判断基準：\n" +
                         "- アポイント：顧客が対面での打ち合わせや訪問に同意した場合\n" +
                         "- 断り：顧客が明確に興味がない、必要ない、遠慮したいなどと述べた場合\n" +
                         "- 継続検討：顧客が検討する、持ち帰る、後日連絡するなどと述べた場合\n" +
                         "- 不明：上記に該当しない場合\n";
      ...
      var validatedInfo = {
        ...
        summary: extractedInfo.summary || "通話内容から明確な結論は得られませんでした。"
      };
